...
add('cb-gp','動作の途中にも、ガードできる瞬間がある。','動作中ずっとガード、ではない。',[
 ['変形などの動作',wpn('sword',74,102,.75)+arrow(118,88,28)+wpn('axe',199,102,.7)],['盾が前に出る瞬間',man('guard',119,116,1.1)+arrow(241,101,-59,red)],['受け止める',man('guard',119,116,1.1)+burst(166,104)+line('M177 61q38 32 0 71',gold,3)]]);
